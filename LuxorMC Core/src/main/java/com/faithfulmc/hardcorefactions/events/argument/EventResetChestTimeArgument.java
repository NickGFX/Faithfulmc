...
public class EventResetChestTimeArgument extends CommandArgument {
    private final HCF plugin;


    public EventResetChestTimeArgument(HCF plugin) {

        super("resetchesttime", "Resets a chest time for a citadel event");
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        ((CitadelFaction)faction).setLastChestReset(null);
        sender.sendMessage(ConfigurationService.YELLOW + "Chest time reset complete");
        return true;
