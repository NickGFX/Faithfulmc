...
public class FactionSubtractPointsArgument extends CommandArgument {
    private final HCF plugin;

    public FactionSubtractPointsArgument(final HCF plugin) {
        super("subtractpoints", "Adds to the Points of a faction.");
        this.plugin = plugin;
