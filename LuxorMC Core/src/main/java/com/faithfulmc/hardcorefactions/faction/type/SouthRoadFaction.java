...
public class SouthRoadFaction extends RoadFaction implements ConfigurationSerializable {
    public SouthRoadFaction(){

    }

    public SouthRoadFaction(HCF plugin) {
        super("SouthRoad");
        for (World world : Bukkit.getWorlds()) {
            ...
            this.addClaim(new Claim(this, new Location(world, -ROAD_WIDTH / 2 + 0.5, ROAD_MIN_HEIGHT, offset), new Location(world, ROAD_WIDTH / 2, ROAD_MAX_HEIGHT, (double) (borderSize - 1))), null);
        }
    }
